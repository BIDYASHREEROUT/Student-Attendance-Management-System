...
if(isset($_POST['submit']))
{
	foreach($_POST['attendance_status'] as $id=>$attendance_status)
	{
		...
		$date=date("Y-m-d");
		 ...
		 mysqli_query($con,"insert into attendance_records_it_sp(student_id,student_name,attendance_status,date)values('$sid','$sname','$attendance_status','$date')");
...
<div class="panel panel-default container ">
	 ...
	 <div class="panel panel-body">
	   ...
	   <form action="it_attendance_register_sp.php" method="Post">
