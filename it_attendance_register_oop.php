...
if(isset($_POST['submit']))
{
	foreach($_POST['attendance_status'] as $id=>$attendance_status)
	{
		...
		$date=date("Y-m-d");
		 ...
		 mysqli_query($con,"insert into attendance_records_it_oop(student_id,student_name,attendance_status,date)values('$sid','$sname','$attendance_status','$date')");
...
<div class="panel panel-default container ">
	 ...
	 <div class="panel panel-body">
	   ...
	   <form action="it_attendance_register_oop.php" method="Post">
		...
		<?php  $result=mysqli_query($con,"select sid,sname FROM student WHERE branch='IT'");
		...
		<input type="radio" name="attendance_status[<?php  echo $counter;   ?>]" value="Absent">Absent</input>
	     ...
	     <?php
		  ...
		  <a href="it_subject.php"> <button type="button" name="back" value="back" class="btn btn-success pull-right">BACK</button></a>
