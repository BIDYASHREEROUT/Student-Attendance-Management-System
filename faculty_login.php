...
<head>
  ...
  <h3 class=" container well text-center" style="color:#006666"> <b> FACULTY LOGIN</b></h3>
...
<?php
       if ($_POST['submit']){
        ...
        $sql="SELECT * FROM faculty_login WHERE F_ID='$username' AND Faculty_Password='$password'";
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="color:#006666" align="center"><b><u>SIGN IN</u></b></h3>
                    </div>
